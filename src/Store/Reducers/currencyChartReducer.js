import { FETCH_TIMESERIES, PENDING_TIMESERIES, GET_TIMESERIES } from '../Actions/actionTypes';
...
const timeSerieNormalization = (state, action) => {
    ...
    let chobi = [];
    Object.entries(rates).forEach(([key, value]) => chobi.push({x: new Date(key), y: Object.values(value)[0]}))
